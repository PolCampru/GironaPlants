...
const content: Record<string, AboutUsFallbackContent> = {
  es: {
    ...
    subtitle:
      "Girona Plants es una empresa familiar con más de 30 años de experiencia en el comercio de planta. No tenemos producción propia, y es deliberado: nos permite elegir, especie por especie, el vivero que mejor la cultiva. Compramos en una red de viveros de confianza en España y el resto de Europa y servimos pedidos completos, de la primera planta a la última.",
    ...
    our_clients: {
      ...
      clients: withIcons([
        { name: "Viveros", description: "Suministro entre profesionales y planta joven para engorde." },
        ...
        { name: "Fruticultores", description: "Frutales y planta destinada a producción, adaptada al clima." },
  ...
  ca: {
    ...
    subtitle:
      "Girona Plants és una empresa familiar amb més de 30 anys d'experiència en el comerç de planta. No tenim producció pròpia, i és deliberat: ens permet triar, espècie per espècie, el viver que millor la cultiva. Comprem en una xarxa de vivers de confiança a Espanya i la resta d'Europa i servim comandes completes, de la primera planta a l'última.",
    ...
    our_clients: {
      ...
      clients: withIcons([
        { name: "Vivers", description: "Subministrament entre professionals i planta jove per engreixar." },
        ...
        { name: "Fruticultors", description: "Fruiters i planta destinada a producció, adaptada al clima." },
  ...
  en: {
    ...
    subtitle:
      "Girona Plants is a family-run company with more than 30 years in the plant trade. We have no production of our own, and that is deliberate: it lets us pick, species by species, the grower who raises it best. We buy through a trusted network of nurseries across Spain and the rest of Europe, delivering complete orders wherever the project is.",
    ...
    our_clients: {
      ...
      clients: withIcons([
        { name: "Nurseries", description: "Trade-to-trade supply and young plants for growing on." },
  ...
  fr: {
    ...
    subtitle:
      "Girona Plants est une entreprise familiale forte de plus de 30 ans d'expérience dans le négoce de plantes. Nous n'avons pas de production propre, et c'est délibéré : cela nous permet de choisir, espèce par espèce, le pépiniériste qui la réussit le mieux. Nous achetons auprès d'un réseau de pépinières de confiance en Espagne et dans le reste de l'Europe, pour livrer des commandes complètes.",
